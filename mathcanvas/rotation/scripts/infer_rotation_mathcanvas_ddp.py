#!/usr/bin/env python3
"""
Two-GPU (DDP) inference on the rotation dataset using MathCanvas/BAGEL-Canvas.
Prompt format follows Orthus rotation script.
"""
import argparse
import json
import math
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="MathCanvas rotation inference (DDP).")
    ...
    parser.add_argument("--output-dir", default="./outputs/rotation_mathcanvas_ddp", help="Output directory for generated texts.")
